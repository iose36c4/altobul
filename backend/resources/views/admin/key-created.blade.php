...
@section('title', 'Clave API creada - Altobul Admin')
    ...
    <div class="w-full max-w-2xl mx-auto mt-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Clave API creada</h2>
            ...
            <div class="bg-gray-900 rounded-lg p-6 mb-6">
                <p class="text-xs text-gray-400 mb-2 uppercase font-medium">Tu clave API ({{ $keyType }})</p>
                <div class="flex items-center gap-3">
                    <code id="api-key-display"
                          class="text-green-400 text-sm font-mono break-all flex-1 select-all">{{ $rawKey }}</code>
                ...
                <p class="text-xs text-gray-500 mt-3">Nombre: <span class="text-gray-300">{{ $keyName }}</span></p>
            </div>
